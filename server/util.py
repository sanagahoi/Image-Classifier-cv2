...
def classify_image(image_base64_data, filepath=None):
    ...
    for img in imgs:
        ...
        scaled_img_harr = cv2.resize(img_har, (32,32))
...
def load_artifacts():
    ...
    global __model
    if __model is None:
        with open('./artifacts/save_img_model.pkl', 'rb') as f:
            __model = joblib.load(f)
    print("loading artifacts model...")
...
if __name__ == "__main__":
    load_artifacts()
    print(classify_image(None, "../test_images/com_ (4).jpg"))